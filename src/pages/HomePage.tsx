            ...
            <main>
                ...
                <section className="pb-24 bg-white overflow-hidden">
                    <div className="container-custom px-4">
                        ...
                        >
                            CHOOSE <br className="sm:hidden" /> YOUR <span className="text-primary-light underline decoration-primary-light/20">WEED</span>
                        </motion.h2>
                        ...
                        >
                            <AnimatePresence mode="popLayout">
                                {[...Array(8)].map((_, i) => (
                                    <ProductCard
                                        key={i}
                                        image={`https://via.placeholder.com/400?text=Product+${i + 1}`}
                                        category="Flower"
                                        title="Premium Indica Variety Pack High Potency"
                                        rating={4.8}
                                        reviews={120}
